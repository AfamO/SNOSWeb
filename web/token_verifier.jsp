...
<tr>
    ...
    Verify My Token</font></b></td>
</tr>
<tr>
     <td width="400" height="10" bgcolor=" "  align="center" colspan="2">
     <font face="Times New Roman" size="2" color="red">
     Note that the fields that are marked with * are compulsory  AND THAT YOU WILL BE RE-DIRECTED TO CREATE NEW PASSWORD PAGE ONCE THE OPERATION IS SUCCESSFULLY CARRIED OUT.</font></td>
</tr>
<tr>
...
<input type="submit" value="Verify Token" name="action"  class="buttonDisplay" >
 &nbsp; <input type="reset" value="Reset" name="can" class="buttonDisplay" >
<input type="hidden" value="verify_token" name="id" >
