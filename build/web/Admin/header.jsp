<%-- 
    Document   : header
    Created on : Apr 18, 2013, 8:03:44 AM
    Author     : Charles
--%>
...
<link href="resources/Style/adminCss.css" rel="stylesheet" type="text/css">
<style type="text/css">
<!--
.style1 {color: #003366}
-->
...
<body>
<table width="75%" height="100%"  cellspacing="0" cellpadding="0" align="center"  bgcolor="white">
  <tr>
  ...
  <tr>
    <td class="mbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><p><img src="resources/images/spacer.gif" alt="" width="1" height="14"></p>
          <p>&nbsp;</p></td>
      </tr>
      <tr>
     ...
     <tr>
      ...
      <tr>
        <td class="menu"><a href="AdminReport.jsp">Generate Report</a></td>
      </tr>
